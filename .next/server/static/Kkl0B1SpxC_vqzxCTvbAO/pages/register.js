...
/* harmony import */ var components_text_input__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__("7fPw");
/* harmony import */ var services__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__("GwW/");
/* harmony import */ var utils_auth__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("q+Fc");
...
`;
const LoginForm = styled_components__WEBPACK_IMPORTED_MODULE_1___default.a.form`
  margin: 20px auto;
  width: 40%;
`;
...
const Registration = () => {
  ...
  const onSubmit = async e => {
    ...
    try {
      const api = new services__WEBPACK_IMPORTED_MODULE_3__[/* AuthApi */ "a"]();
      api.setup();
      ...
      if (response.kind === "ok") {
        ...
        Object(utils_auth__WEBPACK_IMPORTED_MODULE_4__[/* login */ "d"])(token);
      } else {
        setIsError(true);
      }
    } catch (err) {
  ...
  return (//    <Layout>
    __jsx(Container, {
      ...
      onSubmit: onSubmit
    }, __jsx(components_text_input__WEBPACK_IMPORTED_MODULE_2__[/* TextInput */ "a"], {
      label: "First name",
      id: "firstName",
      name: "firstName",
      value: firstName,
    ...
    }, "Create account"))), isError && __jsx("div", {
      className: "mt-4 alert alert-danger",
      role: "alert"
    }, "There's an error while creating new account, please try again!")) //    </Layout>
...
module.exports = __webpack_require__("4/2y");
